										...
										<div class="tab-content-inner active" data-content="signup">
											...
											<form action="#">
												...
												<div class="col-md-12">
													...
													<div class="col-md-12">
														<label for="fullname">Phone Numper</label>
														<input type="text" id="fullname" class="form-control">
												</div>
												<div class="row form-group">
													<div class="col-md-12">
												...
												<div class="row form-group">
													<div class="col-md-12">
														...
														<select name="#" id="destination" class="form-control">
															...
															<option value="">Siwa Osis</option>
															<option value=""> Dahab</option>
															<option value="">Harghada</option>
															<option value="">Nothe Cost</option>
					...
					if(mysqli_num_rows($sql_run) > 0)
					{
						foreach($sql_run as $items)
						{
							...
							<div class="col-lg-4 col-md-4 col-sm-6">
								<a href="admin/<?php echo $items['image_1']?>" class="fh5co-card-item image-popup">
									<figure>
										<div class="overlay"><i class="ti-plus"></i></div>
										<img src="admin/<?php echo $items['image_1']?>" alt="Image" class="img-responsive">
									</figure>
									<div class="fh5co-text">
										<h2><?=$items['country'];?>, <?=$items['city'];?></h2>
										<p><?php echo $items['description']?></p>
										<p><a href="booking.php?htid=<?=$items['htid']?>" class="btn btn-primary">Schedule a Trip</a></p>
									</div>
								</a>
							</div>
							<?php
